...
public class consultarCursoFragmento extends Fragment implements Response.Listener<JSONObject>, Response.ErrorListener{
    ...
    private void carregarWEBService() {
        ...
        progresso.show();
            ...
            String url = "http://192.168.2.162/webservices/consultar.php?codigo=" + campoCodigo.getText().toString() + " ";
            //url = url.replace(" ", "%20");
            //teste
...
//            tabCurso.setDado(jsonObject.optString("imagem"));
        ...
        //Log.v("ERRO", campoCodigo.getText().toString());
        campoNome.setText("Nome: " + tabCurso.getNome().toString());
        campoCategoria.setText("Categoria: " + tabCurso.getCategoria().toString());
        campoProfessor.setText("Professor: " + tabCurso.getProfessor().toString());
/*
